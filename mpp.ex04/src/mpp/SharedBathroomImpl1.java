 ...
 * Answer to exercise 96 (1) in the book
 */
public class SharedBathroomImpl1 {
	 ...
	 */
	public void enter(GenderParams myGender){
	 ...
	 */
	public void leave(GenderParams myGender){
		GenderParams otherGender = (myGender.gender == Gender.MALE) ? females : males;
		// attain lock
		lock.lock();
		try{
			...
			if (myGender.counter == 0){
				otherGender.waitCond.signalAll();
